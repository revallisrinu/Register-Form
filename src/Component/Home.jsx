...
const Home = ({ readOnly = false }) => {
   ...
   return (
      <>
         ...
         <ul>
            <li><NavLink to={'/'} className="underline">Home</NavLink></li>
         ...
         <table border={2}  width="100%" cellSpacing='5px' rules='all'>
            <thead>
               <tr>
                  <th>SL.NO</th>
                  <th>NAME</th>
               ...
               {details == null ? (
                  ...
                  details.map((ele, index) => (
                     <tr key={index} style={{ textAlign: "center" }}>
                        ...
                        <td>
                          <div className="btn1">
                           <button disabled={readOnly} onClick={() => handleEdit(ele.id)} className='edi-btn'>Edit</button>
                           <button disabled={readOnly} onClick={() => handleDelete(ele.id)} className='edi-btn'>Delete</button>
                          </div>
                        </td>
                     </tr>
                  ))
